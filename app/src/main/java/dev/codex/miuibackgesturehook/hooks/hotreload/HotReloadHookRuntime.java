...
//
//import static dev.codex.miuibackgesturehook.hooks.core.HookRuntimeCore.BUILD_MARK;
//
...
//        // Android 17 home is native hook, it will write SavedInstanceState with null
//        if (param.getSavedInstanceState() == null) return;
//
//        int replaced = 0;
...
//                Context application = (Context) currentApplication.invoke(null);
//                if (application == null)
//                    throw new IllegalStateException("currentApplication is null??!");
//                sourceDir = application.getApplicationInfo().sourceDir;
//            } catch (Throwable throwable) {
//                moduleLog(Log.WARN, TAG, "Unable to get sourceDir of currentApplication", throwable);
//                throw new IllegalStateException("Unable to get sourceDir of currentApplication", throwable);
//            }
//
//            installGoogleAppHooks(hotReloadClassLoader, sourceDir);
//        }
